...
| Auditor behavior | `python scripts/test_audit_readme.py` | 31 tests passed | Bilingual structure, centered H1 titles, dotted numbering, caption placement, list nesting, Mermaid, terminology, Chinese full stops and line-ending semicolons, links, secrets, and visual assets |

...
| Auditor behavior | `python scripts/test_audit_readme.py` | 25 tests passed | Bilingual structure, centered H1 titles, dotted numbering, caption placement, list nesting, Mermaid, terminology, Chinese punctuation, links, secrets, and visual assets |

...
<p>让每个项目都能清楚说明用途，让第一次访问的人知道怎样开始</p>
<p><a href="README.en.md">英文说明</a> · <a href="#get-started">开始使用</a> · <a href="references/adaptive-template.md">选择模板</a> · <a href="references/hero-playbook.md">选择头图</a></p>
</div>

<div align="center">
<img src="docs/assets/readme/hero.svg" alt="三张文档共享标题和正文结构，蓝色、绿色与紫色模块展示不同内容组合">
<p>图 1.1　三种内容共用相同的文档骨架</p>
</div>
...
- 第一步，把本仓库作为本地技能提供给助手，入口为 [技能说明](SKILL.md)
